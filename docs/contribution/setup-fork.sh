...
# upstream   https://github.com/gilsonsouzah/ProxmoxVE.git (fetch)
# upstream   https://github.com/gilsonsouzah/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/gilsonsouzah/ProxmoxVE"
echo ""
